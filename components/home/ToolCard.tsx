...
export function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <Link
      href={`/${tool.slug}`}
      className="group relative block h-10  min-h-[110px] border border-border bg-bg-elevated p-4 transition-all duration-200 ease-out hover:border-border-hover hover:bg-bg-subtle"
    >
